...
export const anggaranEWPKonsultingSlice = createSlice({
  name: "anggaranEWPKonsulting",
  initialState,
  reducers: {
...
} = anggaranEWPKonsultingSlice.actions;

export default anggaranEWPKonsultingSlice.reducer;
