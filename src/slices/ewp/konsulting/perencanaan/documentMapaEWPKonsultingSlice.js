...
export const documentMapaEWPKonsultingSlice = createSlice({
  name: "documentMapaEWPKonsulting",
  initialState,
  reducers: {
...
} = documentMapaEWPKonsultingSlice.actions;

export default documentMapaEWPKonsultingSlice.reducer;
