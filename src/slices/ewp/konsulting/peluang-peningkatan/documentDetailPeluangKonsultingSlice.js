...
export const documentDetailPeluangKonsultingSlice = createSlice({
  name: "documentDetailPeluangKonsulting",
  initialState,
  reducers: {
...
} = documentDetailPeluangKonsultingSlice.actions;

export default documentDetailPeluangKonsultingSlice.reducer;
