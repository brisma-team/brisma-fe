...
export const documentMatrixPeluangKonsultingSlice = createSlice({
  name: "documentMatrixPeluangKonsulting",
  initialState,
  reducers: {
...
} = documentMatrixPeluangKonsultingSlice.actions;

export default documentMatrixPeluangKonsultingSlice.reducer;
