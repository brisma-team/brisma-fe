    ...
    <body>
      <main>
        ...
        >
          ...
          <div style="margin-top: 0.5rem">
            ...
            >
              ...
              <p style="justify-self: left">${data?.Year ? data.Year : "**"}</p>
            </div>
          </div>
        </div>
        <article>
        ...
        <article>
          <h4>IV.</h4>
          <section>
            <h4>PEMETAAN PRIORITAS PAT TERHADAP PROSES BISNIS UNIT KERJA</h4>
                ...
                <table style="width: 100%">
                  <thead>
                    <tr>
                      <th
                        rowspan="2"
                        style="background-color: #3c64b1; color: white"
                      >
                      ...
                      <th
                        ...
                        style="background-color: #3c64b1; color: white"
                      >
                        <p style="text-align: center">Proses Bisnis</p>
                      </th>
                      <th
                        rowspan="2"
                        style="background-color: #3c64b1; color: white"
                  ...
                  <tbody>
                    <tr>
                      <td
                        style="
                          text-align: center;
                          background: rgba(60, 100, 177, 0.5);
                        "
                      >
                        { idx + 1 }
                      </td>
                      <td style="background: rgba(60, 100, 177, 0.5)">
                        { item.mega_proses_name }
                      </td>
                      <td style="background: rgba(60, 100, 177, 0.5)"></td>
                      <td style="background: rgba(60, 100, 177, 0.5)"></td>
                    </tr>
                    <tr>
                      <td style="background: rgba(60, 100, 177, 0.3)"></td>
                      <td style="background: rgba(60, 100, 177, 0.3)">
                        { item.major_proses_name }
                      </td>
                      <td style="background: rgba(60, 100, 177, 0.3)"></td>
                      <td style="background: rgba(60, 100, 177, 0.3)"></td>
                    </tr>
        ...
        <article>
          <h4>VI.</h4>
          <section>
            <h4>RINGKASAN DAFTAR PENUGASAN AUDIT</h4>
            <div style="padding-left: 1rem; padding-right: 1rem">
              <style>
  table {
    border: 1px solid;
    ...
    padding: 15px;
      ...
      <figure class="table">
          <table style="width: 100%;">
              ...
              <td>{
                item.ref_sub_aktivitas_name + " - " + item.ref_sub_major_name
              }</td>
              <td>{item.risk_issue_kode}</td>
              <td>{
                item.auditor &&
                item.auditor.map(
                  (val) => 
                <li>{val.pn_auditor + " - " + val.name_auditor}
      ...
      .map(
        (item, idx) => 
          <strong><p>Manual Control: {
            item.sub_aktivitas_name + " - " + item.sub_major_name
          }</p></strong>
          <table>
              <thead>
                  <tr>
              ...
              <tbody>
                      ...
                      <tr>
                          <td>{
                            <strong>{val.risk_issue_kode}</strong> +
                            " - " +
                            val.risk_issue_name
                          }</td>
                          <td>{val.program_audit}</td>
                        </tr>
                        ;
                        })
                        .join("")}
  ...
  <figure>
              ...
              <tr>
                  ...
                  <td><p style="text-align:center;">${
                    data?.PenyusunanMapaPlanStart
                      ? dateLocaleString(
                          data.PenyusunanMapaPlanStart.split(".")[0]
                        )
                      : "**"
                  }</p></td>
                  <td><p style="text-align:center;">${
                    data?.PenyusunanMapaPlanEnd
                      ? dateLocaleString(
                          data.PenyusunanMapaPlanEnd.split(".")[0]
                        )
                      : "**"
                  }</p></td>
              </tr>
              <tr>
                  ...
                  <td><p style="text-align:center;">${
                    data?.EntranceMeetingPlanStart
                      ? dateLocaleString(
                          data.EntranceMeetingPlanStart.split(".")[0]
                        )
                      : "**"
                  }</p></td>
                  <td><p style="text-align:center;">${
                    data?.EntranceMeetingPlanEnd
                      ? dateLocaleString(
                          data.EntranceMeetingPlanEnd.split(".")[0]
                        )
                      : "**"
                  }</p></td>
              </tr>
              <tr>
                  ...
                  <td><p style="text-align:center;">${
                    data?.PelaksanaanAuditPlanStart
                      ? dateLocaleString(
                          data.PelaksanaanAuditPlanStart.split(".")[0]
                        )
                      : "**"
                  }</p></td>
                  <td><p style="text-align:center;">${
                    data?.PelaksanaanAuditPlanEnd
                      ? dateLocaleString(
                          data.PelaksanaanAuditPlanEnd.split(".")[0]
                        )
                      : "**"
                  }</p></td>
              </tr>
              <tr>
                  ...
                  <td><p style="text-align:center;">${
                    data?.ExitMeetingPlanStart
                      ? dateLocaleString(
                          data.ExitMeetingPlanStart.split(".")[0]
                        )
                      : "**"
                  }</p></td>
                  <td><p style="text-align:center;">${
              ...
              <tr>
                  ...
                  <td><p style="text-align:center;">${
                    data?.PenyusunanLHAPlanStart
                      ? dateLocaleString(
                          data.PenyusunanLHAPlanStart.split(".")[0]
                        )
                      : "**"
                  }</p></td>
                  <td><p style="text-align:center;">${
                    data?.PenyusunanLHAPlanEnd
                      ? dateLocaleString(
                          data.PenyusunanLHAPlanEnd.split(".")[0]
                        )
                      : "**"
                  }</p></td>
              </tr>
              <tr>
                  ...
                  <td><p style="text-align:center;">${
                    data?.WrapupMeetingPlanStart
                      ? dateLocaleString(
                          data.WrapupMeetingPlanStart.split(".")[0]
                        )
                      : "**"
                  }</p></td>
                  <td><p style="text-align:center;">${
                    data?.WrapupMeetingPlanEnd
                      ? dateLocaleString(
                          data.WrapupMeetingPlanEnd.split(".")[0]
                        )
                      : "**"
                  }</p></td>
              </tr>
    ...
    data?.KetuaTimAudit[1] ? data.KetuaTimAudit[1] : "**"
          ...
          <tr>
              ...
              <td><span style="font-size:20px">:</span></td>
              <td><span style="font-size:20px">{item.pn} - {
  item.nama
}</span></td>
              </tr>
      </tbody>
      ...
      <figure class="table">
        ...
        <footer>
          <div style="display: flex; justify-content: end; margin: 5rem 75px">
            <p>{moment(audit_info.tanggal).format("dddd, DD MMMM YYYY")}</p>
          </div>
