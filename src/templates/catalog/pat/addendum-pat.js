...
export const addendumPatHtml = (year, id) => {
  ...
  const { addendumPATData, addendumPATDataIsLoading } = useAddendumPATById(id);
  ...
  useEffect(() => {
    addendumPATDataIsLoading ? loadingSwal() : loadingSwal("close");
  }, [addendumPATDataIsLoading]);
  return addendumPATDataIsLoading
    ? `<p>Loading data...</p>`
    : `
  <main>
    <header>
                  ...
                  <td style="padding: 10px;">
                    ${
                      c.sebelum == null
                        ...
                        : `<p>
                              Nama Kegiatan: ${
                                c.sebelum.jadwal.name_kegiatan_audit
                              }
                          </p>
                          <p>
                              Tipe Audit: ${
