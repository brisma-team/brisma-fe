...
export default function useViewAllKKPA(
  ...
  let parameters = `year=${year}&source=${type}&id=${id}&limit=${limit}&activity=${activity}&subactivity=${subactivity}&submajor=${submajor}&riskissue=${riskissue}&auditor=${auditor}`;
