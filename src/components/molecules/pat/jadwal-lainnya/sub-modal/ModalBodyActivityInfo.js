							...
							<FormWithLabel
								...
								form={
									<Select
										...
										value={
											activityScheduleOtherData.ref_metode
												?.nama !== "" && {
												label: activityScheduleOtherData
													.ref_metode?.nama,
												value: activityScheduleOtherData
													.ref_metode?.kode,
											}
										}
										isDisabled={isDisabled}
							...
							<FormWithLabel
								...
								form={
									<Select
										...
										isSearchable={false}
										onChange={(e) =>
											handleChangeRef("ref_tipe", e.value)
										}
										value={
											activityScheduleOtherData.ref_tipe
												?.nama !== "" && {
												label: activityScheduleOtherData
													.ref_tipe?.nama,
												value: activityScheduleOtherData
							...
							<FormWithLabel
								...
								form={
									<Select
										...
										value={
											activityScheduleOtherData.ref_jenis
												?.nama !== "" && {
												label: activityScheduleOtherData
													.ref_jenis?.nama,
												value: activityScheduleOtherData
							...
							<FormWithLabel
								...
								form={
									<Select
										...
										isSearchable={false}
										onChange={(e) =>
											handleChangeRef("ref_tema", e.value)
										}
										value={
											activityScheduleOtherData.ref_tema
												?.nama !== "" && {
												label: activityScheduleOtherData
													.ref_tema?.nama,
												value: activityScheduleOtherData
							...
							<FormWithLabel
								...
								form={
									<TextAreaField
										...
										value={
											activityScheduleOtherData.deskripsi
										}
									/>
								}
