...
const workflowExtensionSchema = yup.object().shape({
...
const workflowTerminateSchema = yup.object().shape({
  ref_tim_audit_approver: yup
    .array()
    .of(
      yup.object().shape({
...
export { workflowSchema, workflowExtensionSchema, workflowTerminateSchema };
