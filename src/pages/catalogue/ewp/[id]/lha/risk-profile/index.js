...
const index = () => {
  ...
  // const loadingGet = true;
  // const data = {
  //   profilResikoUKO: "test",
  //   profileResikoUker: "tus",
  //   topTenRisk: "tis",
  //   topTenControl: "tos",
  //   rcmAfterAudit: "tas",
  //   rekapPenyebabTemuan: "tes",
  //   rekapAktivitasTemuan: "tusk",
  // };
  ...
  //   rcmAfterAudit,
  //   rekapPenyebabTemuan,
  //   rekapAktivitasTemuan,
  // } = data;

  // // useEffect(() => {
  // //   getAuditProfileData(lha_id);
  // // }, [getAuditProfileData, lha_id]);
  // const merah = "#ff4d4f";
  // const oranye = "#ff9933";
  // const kuning = "#f5ee22";
  ...
  //   let newOnes = [];
  //   if (profileResikoUker.heatMapRACM.length > 0) {
  //     let i = profileResikoUker.heatMapRACM.length - 1;
  //     while (i >= 0) {
  //       newOnes.push(profileResikoUker.heatMapRACM[i]);
  ...
  //   const { ukerHeats } = profileResikoUker;
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div>
                          ...
                          <ul style={{ listStyleType: "circle" }}>
                            {/* {profileResikoUker?.ukers?.map((item, key) => (
                              <li key={key}>
